                ...
                <div className='row  w-100'>
                    ...
                    <div className='col-md-6 mb-4'>
                        <div className='border border-dark rounded-3 bg-white d-flex align-items-center px-3'>
                            ...
                            <input type='text' className='border-0 rounded-3 p-2 w-100 px-3' placeholder='Enter Product Name' onChange={(e) => { setName(e.target.value) }} />
                        </div>
                    </div>
                    ...
                    <div className='col-md-6 mb-4'>
                        <div className='border border-dark rounded-3 bg-white d-flex align-items-center px-3'>
                            <i className='bi bi-pencil'></i>
                            <input type='file' className='border-0 rounded-3 p-2 w-100 px-3' placeholder='Enter Image' onChange={(e) => { setImage(e.target.files[0]) }} />
                        </div>
                    </div>
                    ...
                    <div className='col-md-12 mb-4'>
                        <div className='border border-dark rounded-3 bg-white d-flex align-items-center px-3 h-auto'>
                            <i className='bi bi-pencil'></i>
                            <textarea className='border-0 rounded-3 p-2 w-100 px-3' placeholder='Enter about Product' onChange={(e) => { setAbout(e.target.value) }} />
                        </div>
                    </div>
