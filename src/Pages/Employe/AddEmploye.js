    ...
    const submit = () => {
        if (!firstName) {
            ...
            try {
                ...
                axios.post(`${BaseUrl.baseUrl}/employe/create`, param).then(res => {
                ...
                <div className='row  w-100'>
                    ...
                    <div className='col-md-6 mb-4'>
                        <div className='border border-dark rounded-3 bg-white d-flex align-items-center px-3'>
                            ...
                            <input type='text' className='border-0 rounded-3 p-2 w-100 px-3' placeholder='Enter First Name' onChange={(e) => { setFirstName(e.target.value) }} />
                        </div>
                    </div>
                    ...
                    <div className='col-md-6 mb-4'>
                        <div className='border border-dark rounded-3 bg-white d-flex align-items-center px-3'>
                            <i className='bi bi-pencil'></i>
                            <input type='text' className='border-0 rounded-3 p-2 w-100 px-3' placeholder='Enter Last Name' onChange={(e) => { setLastName(e.target.value) }} />
                        </div>
                    </div>
